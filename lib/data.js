...
export const products = [
  ...
  },
  {
    ...
    colors: [
      { name: "Forest Green", hex: "#2D4B3F", image: "/images/products/neck-fan-forest-green.png" },
      { name: "Blush Pink", hex: "#E8C2C2", image: "/images/products/neck-fan-blush-pink.png" },
      { name: "Arctic White", hex: "#F5F5F5", image: "/images/products/neck-fan-arctic-white.png" }
    ],
    reviewsList: [
